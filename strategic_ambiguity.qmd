...
- [ ] Open the folder `patterns_principles_exercises` you created when following the setup tutorial, @sec-setup.
- [ ] Copy your file `DAG.csv` into this folder.
- [ ] Load the RStudio project file, `patterns_principles_exercises.Rproj`.
- [ ] In the bottom right panel of RStudio, click the `Files` tab, and open the file `make_dag.R`.

Run the code in that file line by line.
